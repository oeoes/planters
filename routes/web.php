...
Route::group(['prefix' => 'superadmin', 'middleware' => ['auth:superadmin']], function () {
    ...
    Route::group(['prefix' => 'area'], function () {
        Route::group(['prefix' => 'job_type'], function () {
            Route::get('/', [AreaController::class, 'job_type'])->name('superadmin.job_type');
            Route::post('/', [AreaController::class, 'job_type_store'])->name('superadmin.job_type.store');
            Route::put('/{job_type}', [AreaController::class, 'job_type_update'])->name('superadmin.job_type.update');
            Route::delete('/{job_type}', [AreaController::class, 'job_type_delete'])->name('superadmin.job_type.delete');
        });

        Route::group(['prefix' => 'farm'], function () {
            Route::get('/', [AreaController::class, 'farm'])->name('superadmin.farm');
            Route::post('/', [AreaController::class, 'farm_store'])->name('superadmin.farm.store');
            Route::put('/{farm}', [AreaController::class, 'farm_update'])->name('superadmin.farm.update');
            Route::delete('/{farm}', [AreaController::class, 'farm_delete'])->name('superadmin.farm.delete');
        });

        Route::group(['prefix' => 'afdelling'], function () {
            Route::get('/', [AreaController::class, 'afdelling'])->name('superadmin.afdelling');
            Route::post('/', [AreaController::class, 'afdelling_store'])->name('superadmin.afdelling.store');
            Route::post('/getafdelling', [AreaController::class, 'getAfdelling']);
            Route::put('/{afdelling}', [AreaController::class, 'afdelling_update'])->name('superadmin.afdelling.update');
            Route::delete('/{afdelling}', [AreaController::class, 'afdelling_delete'])->name('superadmin.afdelling.delete');
        });

        Route::group(['prefix' => 'block'], function () {
            Route::get('/', [AreaController::class, 'block'])->name('superadmin.block');
            Route::post('/', [AreaController::class, 'block_store'])->name('superadmin.block.store');
            Route::post('/getblock', [AreaController::class, 'getBlock']);
            Route::put('/{block}', [AreaController::class, 'block_update'])->name('superadmin.block.update');
            Route::delete('/{block}', [AreaController::class, 'block_delete'])->name('superadmin.block.delete');
        });

        Route::group(['prefix' => 'block_reference'], function () {
            Route::get('/', [AreaController::class, 'block_reference'])->name('superadmin.block_reference');
            Route::post('/', [AreaController::class, 'block_reference_store'])->name('superadmin.block_reference.store');
            Route::put('/{block_reference}', [AreaController::class, 'block_reference_update'])->name('superadmin.block_reference.update');
            Route::delete('/{block_reference}', [AreaController::class, 'block_reference_delete'])->name('superadmin.block_reference.delete');
        });
    });
    ...
    Route::group(['prefix' => 'foreman'], function () {
        route::get('/', [ForemanController::class, 'index'])->name('superadmin.foreman.index');
        Route::post('/store', [ForemanController::class, 'store'])->name('superadmin.foreman.store'); 
        Route::put('/update/{foreman}', [ForemanController::class, 'update'])->name('superadmin.foreman.update'); 
        Route::delete('/delete/{foreman}', [ForemanController::class, 'delete'])->name('superadmin.foreman.delete'); 
    });
    ...
    Route::group(['prefix' => 'maintain'], function () {
        Route::get('/spraying', [MaintainController::class, 'spraying'])->name('superadmin.maintain.spraying');
        Route::get('/fertilizer', [MaintainController::class, 'fertilizer'])->name('superadmin.maintain.fertilizer');
        Route::get('/circle', [MaintainController::class, 'circle'])->name('superadmin.maintain.circle');
        Route::get('/pruning', [MaintainController::class, 'pruning'])->name('superadmin.maintain.pruning');
        Route::get('/gawangan', [MaintainController::class, 'gawangan'])->name('superadmin.maintain.gawangan');
        Route::get('/pestcontrol', [MaintainController::class, 'pestcontrol'])->name('superadmin.maintain.pestcontrol'); 
    });
