...
<div class="row mt-4">
    <div class="col-md-4">
        <a href="{{ route('manager.farm.afdelling.operating_maintenance_spraying', $afdelling->id) }}">
    ...
    <div class="col-md-4">
        <a href="{{ route('manager.farm.afdelling.operating_maintenance_fertilizer', $afdelling->id) }}">
    ...
    <div class="col-md-4">
        <a href="{{ route('manager.farm.afdelling.operating_maintenance_circle', $afdelling->id) }}">
    ...
    <div class="col-md-4">
        <a href="{{ route('manager.farm.afdelling.operating_maintenance_pruning', $afdelling->id) }}">
    ...
    <div class="col-md-4">
        <a href="{{ route('manager.farm.afdelling.operating_maintenance_gawangan', $afdelling->id) }}">
    ...
    <div class="col-md-4">
        <a href="{{ route('manager.farm.afdelling.operating_maintenance_pcontrol', $afdelling->id) }}">
    ...
    <div class="col-md-4">
        <a href="{{ route('manager.farm.afdelling.operating_maintenance_harvesting', $afdelling->id) }}">
