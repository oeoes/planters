...
<div class="d-flex flex-row-reverse">
    <a href="{{ route('manager.pcontrol.history') }}" class="btn btn-sm btn-outline-info rounded-pill ml-1"><span class="">View History </span> <i class="fas fa-history ml-1 mr-1"></i> </a>
</div>
@endsection
    ...
    <table id="myTable" class="table table-hover table-borderless" style="font-size:11pt">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <a href="{{ route('manager.pestcontrol.detail', [$pestcontrol->block_ref_id, $pestcontrol->id]) }}" class="btn btn-default btn-sm">
