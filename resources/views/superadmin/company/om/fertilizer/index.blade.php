...
<div class="d-flex flex-row-reverse">
    <a href="{{ route('superadmin.fertilizer.history') }}" class="btn btn-sm btn-outline-info rounded-pill ml-1"><span class="">View History </span> <i class="fas fa-history ml-1 mr-1"></i> </a>
</div>
@endsection
